...
source('./vothbeh_test/code/x_helpers_step4.R')
...
dm <- read_csv('./vothbeh_test//data/district/district_municipality_time_table.csv')
key <- read_delim('./vothbeh_test/data/district/key_elections_hdng_amco.csv')
...
#write to csv
write_csv2(data, "./vothbeh_test/data/analysis/dataset_final.csv")
