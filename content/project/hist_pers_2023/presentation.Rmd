...
- Then, we can estimate $\alpha_1$ by:
  ...
  - $\mathbb{E}[\text{Development|RomanRoad & P[RomanRoad]}]$ - $\mathbb{E}[\text{Development|NoRomanRoad & P[RomanRoad]}]$ 
...
```{r demonstration, cache=TRUE, fig.width=4, fig.height=4}
...
```{r plot_rds, cache=T, fig.width=7, fig.height=7}
