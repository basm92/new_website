...
- Study uses objective administrative data on public health service usage

- Research Design: (Generalized) difference-in-difference:

$$
y_{it} = \alpha + \sum_{r=-4}^4 \tau_r I_r + \sum_{r=-4}^4 \beta_r I_r \times \text{Elected}_i + \theta Elected_i + \epsilon_{it}
$$
...
- No null effect on income: Effect on income well-isolated 
  - Since you explicitly condition on the control group consisting of individuals being in a certain baseline income quintile
